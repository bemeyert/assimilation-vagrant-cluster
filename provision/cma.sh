...
set -x
cd /tmp
wget http://bit.ly/assiminstall
bash assiminstall cma
cd /usr/share/assimilation/crypto.d/
cp '#CMA#00000.pub' '#CMA#00001.pub' /vagrant/
systemctl enable assimilation-cma.service
systemctl enable assimilation-nanoprobe.service 
